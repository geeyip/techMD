...
案件查询结果集说明：{"rownum":"排序序号","unit":"录入单位","detail":"案发地点","hatime":"案发时间","fileno":"档案编号","cretime":"录入时间","no":"编号","skind":"细案类别","kind":"案件类别","cname":"案件名称"}
...
警情信息结果集说明：{"rno":"警情编号","detail":"案发地点","rectime":"接警时间","hatime":"案发时间","recunit":"接警单位","name":"警情名称","brief":"简要案情"}
...
案件信息结果集说明：{"summary":"简要案情","unit":"主办单位","rno":"警情编号","detail":"发案地点","status":"案件状态","hadate":"发案时间","cno":"案件编号","place":"发案区划","user":"主办人","redate":"立案时间","skind":"细案类别","kind":"案件类别","cname":"案件名称","sodate":"破案时间"}
